...
##################################################
mexico-flag = image-url("https://raw.githubusercontent.com/bootstrapworld/starter-files/main/projects/flags/mexico-flag-image.png")
...
# 1) After the (#) below, using the image of mexico-flag, describe the composition of the flag of Mexico.
#
...
crest = scale(0.5, 
  image-url("https://raw.githubusercontent.com/bootstrapworld/starter-files/main/projects/flags/mexico-crest-image.png")
)
