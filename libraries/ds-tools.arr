...
import url-file("https://raw.githubusercontent.com/bootstrapworld/starter-files/refs/heads/fall2026/libraries/", "foundations.arr") as F
...
# ds-tools.arr
#
# The Data-Science toolkit: table statistics (mean/median/stdev/etc),
# every charting function (pie/bar/histogram/scatter/box-plot), the
# linear-regression / lr-plot family, and table-manipulation utilities
# (grouping, pivoting, outlier detection, variance/t-tests).
#
