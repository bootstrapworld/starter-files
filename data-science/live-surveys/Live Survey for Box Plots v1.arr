...
FORM = "https://docs.google.com/forms/d/1GrC9gcovvvSILL9oTsBtUkDOaA6Wm8VI0nkDNIVpT9Y/copy"
...
URL = "https://docs.google.com/spreadsheets/d/1zA1RXNzRDKwEcaSO56gOnuVCZ3LvFtVSWn6WBIWkcI8/"
SHEET-NAME = "Form Responses 1"
COLUMNS = [list: "timestamp", "homes"]
...
# 7) Click "Run". You should see a window pop up with a box plot.
...
# Consumes the table and a column and produces a box plot of the data
