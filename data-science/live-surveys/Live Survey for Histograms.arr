use context url-file("https://raw.githubusercontent.com/bootstrapworld/starter-files/fall2026/data-science/live-surveys", "../../libraries/core.arr")
...
FORM = "https://docs.google.com/forms/d/1ejHzL0dLiXN1NMhkvTZuyCtzPF9zZCs7Pgc1_-jH334/copy"
...
URL = "https://docs.google.com/spreadsheets/d/1Qw68z9tjIa-tAZvcTQAsqRVygebxAvyiwk7uWicM5TU/"
SHEET-NAME = "Form Responses 1"
COLUMNS = [list: "timestamp", "age"]
...
# 7) Click "Run". You should see a window pop up with a dot plot on the left and a histogram on the right.
...
# in this case: a dot plot on the left and a histogram beside it on the right.

fun visualize(t):  
  beside(
    scale(4/5, dot-plot(t, "timestamp", "age")),
    scale(4/5, histogram(t, "timestamp", "age", 5)))
end
